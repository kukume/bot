...
import io.ktor.http.*
import me.kuku.common.entity.SmZdmEntity
...
object SmZdmLogic {
    ...
    suspend fun login2(phone: String, code: String): SmZdmLogin {
    ...
    suspend fun wechatQrcode2(smZdmWechatQrcode: SmZdmWechatQrcode): SmZdmLogin {
    ...
    @Suppress("DuplicatedCode")
    suspend fun appQrcode2(smZdmAppQrcode: SmZdmAppQrcode): SmZdmLogin {
    ...
    private suspend fun geeTest(gt: String, challenge: String, referer: String = "https://www.smzdm.com/"): GeeTestResult {
        val result = DaMaGouLogic.geeTest(gt, challenge, referer)
...
data class SmZdmLogin(val cookie: String)