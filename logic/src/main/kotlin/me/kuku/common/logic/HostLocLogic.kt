...
import me.kuku.common.entity.HostLocEntity
...
object HostLocLogic {
                ...
                addInterceptor { chain ->
                    synchronized(this) {
                        ...
                        val returnResponse = if (response.code != 200) {
                            val html = response.body.string().takeIf { it.isNotEmpty() } ?: return@addInterceptor response
    ...
    suspend fun sign(hostLocEntity: HostLocEntity) {
        sign(hostLocEntity.cookie)
    }
